...
## References
- Datasets that were useD in here were taken from [KAGGLE AI MENTAL FITNESS TRACKER](https://www.kaggle.com/datasets/programmerrdai/mental-health-dataset)
- This project was made during my internship period for [Edunet Foundation](https://edunetfoundation.org) in association with [IBM SkillsBuild ORGANISATION](https://skillsbuild.org) and [AICTE](https://internship.aicte-india.org)
